...
def delta_degree_cal(x, z, y, x_n, z_n, y_n, n):
    ...
    return math.asin(sin_delta_degree)
...
print(delta_degree_cal(a, c, b, a_n, c_n, b_n, 1))
print(delta_degree_cal(a, c, b, a_n, c_n, b_n, 2))
print(delta_degree_cal(a, c, b, a_n, c_n, b_n, 3))
t = 0
'''
